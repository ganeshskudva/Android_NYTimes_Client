# Project 2 - *Android_NYT_Client*

**NYT_Client** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
<img src=NYT_Client.gif title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

* Getting data & parsing it from NYT api was difficult than previous assignment
* Faced issues with heterogenous layouts. Butterknife was not binding some items in heterogenous layouts.
...
## License
    ...
    Copyright [Ganesh Kudva] [name of copyright owner]
